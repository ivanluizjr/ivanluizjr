...
- 🌱 Sou Desenvolvedor Flutter e estou fazendo Pós-Graduação em Desenvolvimento Mobile, onde também terei conhecimento das plataformas nativas Kotlin para Android e Swift para IOS.
